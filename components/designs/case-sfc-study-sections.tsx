      ...
      <section className="mx-auto w-full max-w-[1440px] bg-[#FAFAFA] py-20 sm:py-[108px] lg:py-[124px]">
        <div className="mx-auto w-full max-w-[1320px]">
          ...
          <div className="grid grid-cols-1 gap-[24px] lg:grid-cols-2">
            <div className={SFC_FEATURED_CARD_WRAP}>{renderRelatedCaseCard(relatedCards[0])}</div>
            <div className={SFC_FEATURED_CARD_WRAP}>{renderRelatedCaseCard(relatedCards[1])}</div>
          </div>
